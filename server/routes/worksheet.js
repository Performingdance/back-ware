...
router.post("/new", isLoggedIn, (req, res) => {
   ...
   UNION
   SELECT c.date, c.recipeID, c.recipe_mass, (dough.amount_pc * c.ing_mass) AS ing_mass, dough.ingredientID AS base_ingID, c.base_recipeID, dough.base, c.titleID AS titleID, c.sortID AS sortID, "" AS note,  "2" AS "level"
   ...
   UNION
   SELECT e.date, e.recipeID, e.recipe_mass, (dough.amount_pc * e.ing_mass) AS ing_mass, dough.ingredientID AS base_ingID, e.base_recipeID, dough.base, d.titleID AS titleID, d.sortID AS sortID, "" AS note,  "3" AS "level"
