      ...
      <div className='popup-card  '>
        ...
        <h3 className='ta-c'>Produkt der Rechnung hinzufügen</h3>
          ...
          <div className="popup-title jc-c">
            ...
            <input className='' type="number" defaultValue={amountRef.current} onChange={(e)=>{amountRef.current = e.target.value}}></input>
            <p className='lb-title '>MwSt (%)</p>
            <input className='' type="number" defaultValue={taxRef.current} onChange={(e)=>{taxRef.current = e.target.value}}></input>
            <p className='lb-title '>Einzelpreis</p>
            <input className='' type="number" defaultValue={price_pieceRef.current.replace(",",".")} onChange={(e)=>{price_pieceRef.current = e.target.value}}></input> 
            <p className='lb-title '>Gesamtpreis</p>
            <input className='' type="number" defaultValue={price_totalRef.current} onChange={(e)=>{price_totalRef.current = e.target.value}}></input>                    
