...
function Clients() {
  ...
  return (
    <ClientCard onClickOrder={() => [ setEditBtn(1), handleToggleEditID(client.ID)]} onClickInfo={() => [ setEditBtn(2),handleToggleEditID(client.ID)]} editID={editID} editBtn={editBtn} key={client.ID} client={client} />
  )
  });
